...
<link rel="stylesheet" href="css/jquery-ui-1.9.2.custom.css"> 
	...
	PreparedStatement stm2 = conexion.prepareStatement("SELECT nombre_paciente,CURP, id_paciente FROM paciente WHERE CURP = ? ");
				...
				<div class="12u skel-cell-important">
					...
					<div id="content">
						<article class="last">
							...
							<h2>Agregar al expediente</h2>
						<% while(rs2.next()){idpac = rs2.getString("id_paciente"); out.print("<h1 style='font-size:20px;'>  Nombre del paciente: " +rs2.getString("nombre_paciente") + "</h1>");
						...
						function showAndClearField(frm){
						  if (frm.tratamientos.value == "")
						      alert("Favor de rellenar el campo de tratamientos");
						  else if(frm.notas_hosp.value == "")
							  alert("Favor de rellenar el campo notas hospitalarias");
						  else if(frm.notas_quirur.value=="")
							  alert("Favor de rellenar el campo notas qurirugias");
						  else if(frm.interconsultas.value=="")
							  alert("Favor de rellenar el campo interconsultas");
						  else if(frm.repo_radiolog.value=="")
							  alert("Favor de rellenar el campo reporte de radiologia");
						  else if(frm.exa_lab.value=="")
							  alert("Favor de rellenar el campo examen de laboratorio");
						  else if(frm.notas_ambulatorias.value=="")
							  alert("Favor de rellenar el campo notas ambulatorias");
						     ...
						     // alert("The field contains the text: " + frm.tratamientos.value + frm.notas_hosp.value + frm.notas_quirur.value + frm.interconsultas.value + frm.repo_radiolog.value + frm.exa_lab.value + frm.notas_ambulatorias.value);
						      loadContent(frm.tratamientos.value, frm.notas_hosp.value, frm.notas_quirur.value, frm.interconsultas.value,frm.repo_radiolog.value,frm.exa_lab.value,frm.notas_ambulatorias.value,frm.idpaciente.value);
						//  frm.firstName.value = "";
						...
						<form>
						<input type="hidden" name="idpaciente" value="<%=idpac %>">
						<footer style="overflow-x:scroll; max-width:100% " >
                         <table style="float:left; max-width:100%; overflow-x:scroll;">
								...
								<tr>
									...
									<tr>
										 ...
										 <td><input type="text" name="tratamientos" placeholder="Introduce el tratamiento"></td>
										 <td><input type="text" name="notas_hosp" placeholder="Introduce las notas hospital"></td>
										 <td><input type="text" name="notas_quirur" placeholder="Introduce las notas quirurgicas" ></td>
										 <td><input type="text" name="interconsultas" placeholder="Introduce las interconsultas"></td>
										 <td><input type="text" name="repo_radiolog" placeholder="Reportes del departamento de radiología"></td>
										 <td><input type="text" name="exa_lab" placeholder="¿Algun examen de laboratorio realizado"></td>
										 <td><input type="text" name="notas_ambulatorias" placeholder="¿Notas ambulatorias?"></td>
										</tr>
									...
									<INPUT TYPE="Button" Value="Agregar tratamiento al paciente" onClick="showAndClearField(this.form)">
								</p>
