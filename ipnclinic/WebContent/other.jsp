...
<script language="javascript">
   ...
   <img src="images/picture.png" width="350" height="350"  alt="baner">
   </div>
   ...
   <form action='login' method='post' >
			...
			<table border="0">
				<tr>
					<td>Usuario:<br> <input type='text' name='username'
						 required/></td>
				</tr>
				<tr>
					<td>Password:<br> <input type="password" name='pwd' required>
					</td>
				</tr>
				<tr>
					<td><input type="submit" value='Inicia Sesion'></td>
				</tr>
				<tr>
					<td><a href="registro1.jsp">O crea una cuenta nueva</a></td>
				</tr>
				<tr>
					<td><a href="recover.jsp">Recuperar cuenta</a></td>
				</tr>
			</table>
		</form> 
   </h4>
