							...
							<!-- Header -->
								<header id="header">
									...
									<!-- Nav -->
										<nav id="nav">
											<ul>
												<li class="current_page_item"><a href="index.html">Bienvenido</a></li>
												<li><a href="left-sidebar.html">Pacientes</a></li>
												<li><a href="right-sidebar.html">Personal Médico</a></li>
												<li><a href="no-sidebar.html">Medicamentos</a></li>
											</ul>
										</nav>
									...
									<div>
										<div class="row">
											<div class="7u">
												...
												<img src="images/ipn.png" width="110" height="130">
												<img src="images/escom.png" height="130" width="160">
												<img src="images/enmh.PNG" height="130" width="130">
												<p>Por favor ingrese su usuario y contraseña para acceder al sistema.</p>
											</div>
											<div class="5u" >
												<ul>
													<li>
													<form action='login' method='post' class="button big fa fa-check" >
													Usuario<br>
													...
													<br><br>
													<input type="submit" value="Sign In" style="font-size: 15px; background-color:#3b7dd7" class="button fa" >
													</form>
													</li>
													<li><a href="registro.jsp" class="button alt big fa fa-pencil">Registrarse</a></li>
												</ul>
											</div>
										</div>
									</div>
							...
							<!-- Box -->
								<section class="box box-feature">
									...
									<div class="inner">
										...
										<p>You can put all kinds of stuff here, though Iâ€™m not sure what. Maybe a 
										little bit about one of those things you do thatâ€™s so cool?</p>
									</div>
								</section>
							...
							<!-- Content -->
								<div id="content">
									<section class="last">
										...
										Itâ€™s built on <a href="http://skeljs.org">skelJS</a>, which means itâ€™s easy to customize and works very nicely on mobile devices 
										...
										pretty much anything you want (be it a personal project or a commercial venture), just donâ€™t 
